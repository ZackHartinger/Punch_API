    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCompany", x => new { x.AppUsersId, x.CompaniesCompanyId });
                    table.ForeignKey(
                        name: "FK_AppUserCompany_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserCompany_Companies_CompaniesCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LunchDuration = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeWorkDays_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkDays_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkDayTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeWorkDayId = table.Column<int>(type: "int", nullable: true),
                    WorkTaskId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkDayTasks", x => x.WorkDayTaskId);
                    table.ForeignKey(
                        name: "FK_WorkDayTasks_EmployeeWorkDays_EmployeeWorkDayId",
                        column: x => x.EmployeeWorkDayId,
                        principalTable: "EmployeeWorkDays",
                        principalColumn: "EmployeeWorkDayId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkDayTasks_WorkTasks_WorkTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserCompany_CompaniesCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkDays_CompanyId",
                table: "EmployeeWorkDays",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkDays_UserId",
                table: "EmployeeWorkDays",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkDayTasks_EmployeeWorkDayId",
                table: "WorkDayTasks",
                column: "EmployeeWorkDayId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkDayTasks_WorkTaskId",
                table: "WorkDayTasks",
                column: "WorkTaskId");
